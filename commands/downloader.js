const { tlang, ringtone, cmd, getBuffer, pinterest, prefix, Config } = require('../lib')
...
cmd(
 ...
 async (Void, citel, text) => {
  if (!text) {
   return citel.reply('Please give me Sentence to change into audio.')
  }
  let texttts = text
...
cmd(
 ...
 async (Void, citel, text) => {
  ...
  if (!text) {
   return citel.reply(`Example : ${prefix}yts ${tlang().title} WhatsApp Bot`)
  }
