...
exports.smsg = (conn, citel, store) => {
 ...
 if (citel.message) {
  ...
  citel.msg =
   citel.mtype == 'viewOnceMessage'
    ? citel.message[citel.mtype].message[getContentType(citel.message[citel.mtype].message)]
    : citel.message[citel.mtype]
  try {
   citel.body =
    citel.mtype === 'conversation'
     ? citel.message.conversation
     : citel.mtype == 'imageMessage' && citel.message.imageMessage.caption != undefined
     ? citel.message.imageMessage.caption
     : citel.mtype == 'videoMessage' && citel.message.videoMessage.caption != undefined
     ? citel.message.videoMessage.caption
     : citel.mtype == 'extendedTextMessage' && citel.message.extendedTextMessage.text != undefined
     ? citel.message.extendedTextMessage.text
     : citel.mtype == 'buttonsResponseMessage'
     ? citel.message.buttonsResponseMessage.selectedButtonId
     : citel.mtype == 'listResponseMessage'
     ? citel.message.listResponseMessage.singleSelectReply.selectedRowId
     : citel.mtype == 'templateButtonReplyMessage'
     ? citel.message.templateButtonReplyMessage.selectedId
     : citel.mtype === 'messageContextInfo'
     ? citel.message.buttonsResponseMessage?.selectedButtonId ||
       citel.message.listResponseMessage?.singleSelectReply.selectedRowId ||
       citel.text
     : ''
  ...
  if (citel.quoted) {
   ...
   if (quoted.viewOnceMessageV2) {
    ...
    citel.quoted.isBaileys = citel.quoted.id
     ? citel.quoted.id.startsWith('BAE5') && citel.quoted.id.length === 16
     : false
 ...
 citel.imgurl = (img, teks, id = citel.chat, option = { mentions: [citel.sender] }) =>
  conn.sendMessage(
   id,
   { image: { url: img }, caption: teks, contextInfo: { mentionedJid: option.mentions } },
   { quoted: citel }
  )
 citel.reply = async (content, opt = { packname: 'Secktor', author: 'AstroFx0011' }, type = 'text') => {
